...
public class EvolutionEngine {
    ...
    public void run(EvolutionListener listener) {
        ...
        double bestHistoricalFitness = Double.NEGATIVE_INFINITY;
        for (int gen = 0; gen < generations; gen++) {
            ...
            bestHistoricalFitness = Math.max(bestHistoricalFitness, best);
            ...
            controller.updateChart(bestHistoricalFitness, pEv, bf, af);
