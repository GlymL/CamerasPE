...
public class CromosomasRanger{
    ...
    public CromosomasRanger(int camaras, int drones, ASTNode cromosoma){
        this.drones = drones;
    ...
    public CromosomasRanger clone() {
       return new CromosomasRanger(camaras, drones, cromosoma);
    }

    // public CromosomasRanger[] crucePMX(CromosomasRanger crom, double crossRatio) {
    //     if(r.nextDouble() > crossRatio){
    //         return new CromosomasRanger[]{ this.clone(), crom.clone() };
    //     }
    //     int c1, c2;
    ...
    //     CromosomasRanger[] cd = new CromosomasRanger[2];

    //     cd[0] = new CromosomasRanger(camaras, drones, arr1);
    //     cd[1] = new CromosomasRanger(camaras, drones, arr2);
    //     return cd;

    // }

    // public CromosomasRanger[] cruceOX(CromosomasRanger crom, double crossRatio) {
    //     if(r.nextDouble() > crossRatio){
    //         return new CromosomasRanger[]{ this.clone(), crom.clone() };
    //     }
    //     int c1 = 0, c2 = 0;
    ...
    //     ret[0] = new CromosomasRanger(camaras, drones, arr1);
    //     ret[1] = new CromosomasRanger(camaras, drones, arr2);  

    //     return ret;
    // }

    // public CromosomasRanger[] cruceOXOP(CromosomasRanger crom, double crossRatio) {
    //     if (r.nextDouble() > crossRatio) {
    //         return new CromosomasRanger[]{ this.clone(), crom.clone() };
    //     }
    ...
    //     return new CromosomasRanger[]{
    //         new CromosomasRanger(camaras, drones, hijo1),
    //         new CromosomasRanger(camaras, drones, hijo2)
    //     };
    // }
    ...
    // public CromosomasRanger[] cruceCX(CromosomasRanger crom, double crossRatio) {
    //     if(r.nextDouble() > crossRatio){
    //         return new CromosomasRanger[]{ this.clone(), crom.clone() };
    //     }
    ...
    //     CromosomasRanger[] ret = new CromosomasRanger[2];
    //     ret[0] = new CromosomasRanger(camaras, drones, hijo1);
    //     ret[1] = new CromosomasRanger(camaras, drones, hijo2);  

    //     return ret;
    // }

    // public CromosomasRanger[] cruceCO(CromosomasRanger crom, double crossRatio) {
    //     if(r.nextDouble() > crossRatio){
    //         return new CromosomasRanger[]{ this.clone(), crom.clone() };
    //     }
    ...
    // public CromosomasRanger[] cruceERX(CromosomasRanger crom, double crossRatio) {
    ...
    // public CromosomasRanger[] cruceCUSTOM(CromosomasRanger crom, double crossRatio) {
    //     if (r.nextDouble() > crossRatio) {
    //         return new CromosomasRanger[]{ this.clone(), crom.clone() };
    //     }
    ...
    //     };
    // }
    // public CromosomasRanger mutacionInsercion(double mut) {
    ...
    //         }
    //     }
    //     return new CromosomasRanger(camaras, drones, copy);
    // }

    // public CromosomasRanger mutacionIntercambio(double mut) {
    //     Integer[] copy = cromosoma.clone();
    //     if(r.nextDouble() < mut){
    //         int c1 = r.nextInt(cromosoma.length);
    //         int c2 = r.nextInt(cromosoma.length);
    ...
    // public CromosomasRanger mutacionInversion(double mut) {
    //      Integer[] copy = cromosoma.clone();
    //     if(r.nextDouble() < mut){
    //         int c1 = r.nextInt(cromosoma.length);
    //         int c2 = r.nextInt(cromosoma.length);
    ...
    // public CromosomasRanger mutacionHeuristica(double mut, AEstrellaPrecalc ae) {
    //     int n = 3;
    ...
    //                 }
    //             }
    //             cd[iter++] = new Fitness(new CromosomasRanger(camaras, drones, crom), ae);
    //         }
    //         Fitness best = null;
    //         for(Fitness f : cd){
    //             f.calculateFitness();
...
//     public CromosomasRanger mutacionCustom(double mut) {
//         Integer[] copy = cromosoma.clone();
